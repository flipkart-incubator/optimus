...
## Start Using it
Visit the [Quick Start](https://github.com/flipkart-incubator/optimus/wiki/Quick-Start) guide to get started on using Optimus! I have also written a small [tutorial on Optimus](https://devashishshankar.wordpress.com/2015/07/21/train-an-optimum-text-classifier-using-optimus/) on my blog.
